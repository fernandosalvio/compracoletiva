...
-->
            <th colspan="4" style="text-align:right">Contribuição ao EES no caso de associado (já incluído no valor acima)</th>
...
//				   		$valor_final = $cestante_associado[$i] ? $cestante_valor[$i]*(1+TAXA_ASSOCIADO ): $cestante_valor[$i];
				   		$valor_final = $cestante_associado[$i] ? $cestante_valor[$i] : $cestante_valor[$i];
